...
object ApiConfig {
    ...
    const val FILES_DIRECTORY = "tdlib_files"

    fun tdlibDatabaseDir(c: Context): java.io.File = c.getDir(DATABASE_DIRECTORY, Context.MODE_PRIVATE)
    fun tdlibFilesDir(c: Context): java.io.File    = c.getDir(FILES_DIRECTORY, Context.MODE_PRIVATE)
